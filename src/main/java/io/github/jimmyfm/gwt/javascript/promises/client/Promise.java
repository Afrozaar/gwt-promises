...
public class Promise<S, F> {
     ...
     */
    @JsFunction
    public interface ExecutorFunction<S, F> {
        void exec(final FunctionParam<S> resolve, final FunctionParam<F> reject);
    }

    @JsConstructor
    public Promise(final ExecutorFunction<S, F> executor) {
    }
     ...
     * becomes rejected).
     *
     * @param onFulfilled A Function called when the Promise is fulfilled. This function has one argument, the fulfillment
     *                    value.
     ...
     * resolved Promise.
     */
    public native final Promise<S, F> then(final FunctionParam<S> onFulfilled);
     ...
     * resolved Promise.
     */
    public native final Promise<S, F> then(final FunctionParam<S> onFulfilled, final FunctionParam<F> onRejected);
     ...
     *
     * @param onRejected A Function called when the Promise is rejected. This function has one argument: reason, The rejection
     *                   reason.
     * @return A Promise.
     */
    @JsMethod(name = "catch")
    public native final Promise<S, F> error(final FunctionParam<F> onRejected);
     ...
     *
     * @param promises An iterable object (such as an Array) of promises.
     ...
     */
    @JsMethod
    public native final static <S, F> Promise<S, F> all(final Promise<S, F>[] promises);

    /**
     * Returns a promise that fulfills or rejects as soon as one of the promises in the iterable fulfills or rejects,
     * with the value or reason from that promise.
     *
     * @param promises An iterable object, such as an Array. See iterable.
     * @return A Promise that resolves or rejects as soon as one of the promises in the given iterable resolves or
     * rejects.
     */
    @JsMethod
    public native final static <S, F> Promise<S, F> race(final Promise<S, F>[] promises);

    /**
     * Returns a Promise object that is rejected with the given reason.
     */
    @JsMethod
    public native final static <S, F> Promise<S, F> reject(final Object reason);
